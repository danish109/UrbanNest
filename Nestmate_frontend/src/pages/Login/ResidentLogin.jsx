...
const ResidentLogin = () => {
  ...
  <div className="flex justify-between items-center px-4 sm:px-6 py-3 max-w-7xl mx-auto">
    ...
    <div className="flex items-center gap-2 sm:gap-4">
      ...
      {/* LOGO */}
      <div className="h-10 w-10 sm:h-14 sm:w-14 rounded-xl overflow-hidden cursor-pointer transition-all duration-300 hover:scale-105">
    ...
    <div className="hidden md:flex items-center gap-6">
      ...
      <Link
        to="/"
        className="bg-gradient-to-r from-blue-500 to-purple-500 text-white px-4 py-2 rounded-lg flex items-center gap-2 hover:scale-105 transition"
      >
        Back
  ...
  {/* MOBILE MENU */}
  {isOpen && (
    <div className="md:hidden px-4 pb-4 space-y-3 border-t border-white/20 bg-white/10 backdrop-blur-xl">

      <Link
        to="/"
        className="block py-2 text-slate-700 hover:text-blue-500"
      >
        Home
      </Link>
      ...
      <Link
        to="/"
        className="block bg-gradient-to-r from-blue-500 to-purple-500 text-white px-4 py-2 rounded-lg text-center"
      >
        Back to Home
      </Link>
    </div>
          ...
          >
            <div className="space-y-6">
              ...
              <p className="text-xl text-slate-600 leading-relaxed max-w-2xl">
                Access your personalized resident dashboard with community
                updates, service requests, visitor management, and seamless
                communication tools.
              </p>
              ...
              <div className="grid grid-cols-1 gap-4 pt-8">
                {[
                  ...
                  { icon: <FaClock />, text: "24/7 Service Access" },
                ].map((feature, index) => (
