...
// Define validation schema with Zod for guard signup
...
const GuardSignup = () => {
  ...
  // Embedded styles matching the login page
          ...
          >
            <div className="space-y-6">
              ...
              <p className="text-xl text-slate-600 leading-relaxed max-w-2xl">
                Join our elite security team and gain access to cutting-edge
                monitoring tools, real-time alerts, and comprehensive management
                systems.
              </p>
              ...
              <div className="grid grid-cols-1 gap-4 pt-8">
                {[
                  {
                    icon: <FaShieldAlt />,
                    text: "Advanced Security Training",
                  },
                  {
                    icon: <FaCheckCircle />,
                    text: "Real-time Communication Tools",
                  },
                  { icon: <FaStar />, text: "Professional Development" },
                ].map((feature, index) => (
              ...
              <div className="relative z-10">
                ...
                <div className="text-center mb-8">
                  ...
                  <p className="text-slate-600">
                    Create your guard account to get started
                  </p>
                </div>
                ...
                >
                  ...
                  >
                    ...
                    {errors.fullName && (
                      <p className="text-brand-danger text-xs mt-2 flex items-center gap-1">
                        ...
                        {String(errors.fullName.message || "Invalid input")}
                      </p>
                    )}
                  </motion.div>
                  ...
                  >
                    ...
                    {errors.phone && (
                      <p className="text-brand-danger text-xs mt-2 flex items-center gap-1">
                        <FaLock className="text-xs" />
                        {String(errors.phone.message || "Invalid input")}
                      </p>
                    )}
                  </motion.div>
                  ...
                  >
                    ...
                    {errors.password && (
                      <p className="text-brand-danger text-xs mt-2 flex items-center gap-1">
                        <FaLock className="text-xs" />
                        {String(errors.password.message || "Invalid input")}
                      </p>
                    )}
                  </motion.div>
                  ...
                  >
                    ...
                    {errors.confirmPassword && (
                      <p className="text-brand-danger text-xs mt-2 flex items-center gap-1">
                        <FaLock className="text-xs" />
                        {String(
                          errors.confirmPassword.message || "Invalid input"
                        )}
                      </p>
                    )}
                  </motion.div>
