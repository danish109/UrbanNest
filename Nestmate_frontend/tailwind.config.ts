  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "fade-in-down": "fadeInDown 0.3s cubic-bezier(0.4, 0, 0.2, 1) forwards",
        "fade-in-left": "fadeInLeft 0.3s cubic-bezier(0.4, 0, 0.2, 1) forwards",
        "fade-in-right": "fadeInRight 0.3s cubic-bezier(0.4, 0, 0.2, 1) forwards",
        "scale-in": "scaleIn 0.3s cubic-bezier(0.68, -0.55, 0.265, 1.55) forwards",
        "slide-up": "slide-up 0.4s cubic-bezier(0.4, 0, 0.2, 1) forwards",
        "zoom-in": "zoom-in 0.4s cubic-bezier(0.68, -0.55, 0.265, 1.55) forwards",
